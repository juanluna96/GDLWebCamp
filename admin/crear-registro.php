      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <small>Llena el formulario para registrar a un usuario para el evento</small>
          </div>
          <div class="col-sm-6">
          </div>
        </div>
                              ...
                              <li class="col-md-4">
                                  <div class='tabla-precio text-center'>
                                      ...
                                      <div class='orden'>
                                          ...
                                          <input type='number' class="form-control" name='boletos[un_dia][cantidad]' id='pase_dia' size='3' placeholder='0'
                                              min='0'>
                              ...
                              <li class="col-md-4">
                                  <div class='tabla-precio text-center'>
                                      ...
                                      <div class='orden'>
                                          ...
                                          <input type='number' class="form-control" name='boletos[completo][cantidad]' id='pase_completo' size='3'
                                              placeholder='0' min='0'>
                              ...
                              <li class="col-md-4">
                                  <div class='tabla-precio text-center'>
                                      ...
                                      <div class='orden'>
                                          ...
                                          <input type='number' class="form-control" name='boletos[2dias][cantidad]' id='pase_dosdias' size='3'
                                              placeholder='0' min='0'>
                                  ...
                                  <div class='col-md-4'>
                                      ...
                                      <label>
                                          <div class="icheck-primary d-inline">
                                            <input type="checkbox" name="registro_evento[]" id="checkboxPrimary2" value="<?php echo $evento['id'] ?>">
            ...
            <div class='caja clearfix row'>
                <div class='extras col-md-6'>
                    <div class='orden'>
                        ...
                        <input type='number' class='form-control' id='camisa_evento' name='pedido_extra[camisas][cantidad]' placeholder='0'
                            size='3' min='0'>
                    ...
                    <div class='orden'>
                        ...
                        <input type='number' class='form-control' id='etiquetas' name='pedido_extra[etiquetas][cantidad]' placeholder='0'
                            size='3' min='0'>
