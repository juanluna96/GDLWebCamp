        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Editar un invitado</h3>
            </div>
            <div class="card-body">
...
<div class="form-group">
    ...
    <br>
    <img src="../img/invitados/<?php echo $invitado['url_imagen']; ?>" class="w-50">
</div>
                    ...
                    <input type="hidden" name="id_registro" value='<?php echo $invitado['invitado_id']; ?>'>
                      <button type="submit" class="btn btn-primary" id='crear_registro'><i class="fas fa-user-edit"></i>Editar</button>
                    </div>
              </form>
            </div>
            <!-- /.card-body -->
