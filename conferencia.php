<?php include_once 'includes/templates/header.php';?>
    ...
    <section class="seccion contenedor">
        ...
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est harum explicabo repellendus praesentium. Nihil magni minus, odio, eaque sed error voluptas est aliquid consectetur deleniti officiis accusamus. Atque, consequuntur minima!</p>
    </section>
    <section class="seccion contenedor">
